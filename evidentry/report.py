...
DISCLAIMER = (
    "> **Scope note:** This report was generated by evidentry from the eval "
...
def render_markdown(
    ...
    add("dataset, and every generated artifact. Run `evidentry verify <pack-dir>`")
    add("to confirm the pack matches what was produced (hash-pinning detects")
    add("modification; it is not a signature). Re-running `evidentry run` against")
    ...
    if manifest is not None:
        ...
        add(f"- evidentry version: {manifest['evidentry_version']}")
        add("")
